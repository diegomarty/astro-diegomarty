...
const prompt = [
    {
        "title": "ChatGPT3",
        "prompt": "Crea un post sobre ChatGPT3 que tenga 200 palabras, dame directamente el codigo markdown para que lo pueda copiar y pegar en el editor de markdown."
    }
]

async function runCompletion () {
    console.log(fs.existsSync('src\pages\blog\posts\chatgpt3.md'));
  /*
